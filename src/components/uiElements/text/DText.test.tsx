...
import DText from './index'; // replace with the actual path
...
const Component = (props: PropsWithChildren<TextProps>) => (
  <ThemeProvider theme={theme}>
    <DText {...props}>{props.children}</DText>
  </ThemeProvider>
);

describe('DText component', () => {
  it('matches snapshot with default props', () => {
    const {toJSON} = render(<Component>Hello, DText!</Component>);
